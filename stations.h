...
const char sta3[] PROGMEM = "88.3 WBGO\nJazz 88";
...
const char sta12[] PROGMEM = "91.5 WNYE\nRadio\nNew York";
const char sta13[] PROGMEM = "91.9 WFMU";
const char sta14[] PROGMEM = "92.3 WBMP\nALT FM";
const char sta15[] PROGMEM = "92.7 WQBU\nLa Que\nBuena";
const char sta16[] PROGMEM = "93.1 WPAT\nAmor";
const char sta17[] PROGMEM = "93.5 WVIP";
const char sta18[] PROGMEM = "93.9 WNYC";
const char sta19[] PROGMEM = "94.3 WSBP";
const char sta20[] PROGMEM = "94.7 WNSH\nNash FM";
...
const char sta26[] PROGMEM = "97.1 WQHT\nHot 97";
const char sta27[] PROGMEM = "97.5 WXMC";
const char sta28[] PROGMEM = "97.9 WSKQ\nMega";
const char sta29[] PROGMEM = "98.3 WKJY\nK-Joy";
const char sta30[] PROGMEM = "98.7 WEPN\nESPN\nNew York";
const char sta31[] PROGMEM = "99.1 WAWZ";
const char sta32[] PROGMEM = "99.5 WBAI";
const char sta33[] PROGMEM = "100.3 WHTZ\nZ-100";
...
char stationBuffer[25]; // size is based on largest string in callLetters + 1
